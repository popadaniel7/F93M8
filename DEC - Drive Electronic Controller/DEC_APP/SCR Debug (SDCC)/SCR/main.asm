...
_main:
	.using 0
;	../SCR/main.c:17: Scr_InitCnt++;
	mov	dptr,#_Scr_InitCnt
	movx	a,@dptr
	inc	a
	movx	@dptr,a
;	../SCR/main.c:23: SCR_IO_PAGE = 0x1;
	mov	_SCR_IO_PAGE,#0x01
;	../SCR/main.c:28: SCR_IO_PAGE = 0x2;
	mov	_SCR_IO_PAGE,#0x02
;	../SCR/main.c:29: SCR_P00_PDISC = 0x00 ; // WCANRXDG(P33.07)
	mov	_SCR_P00_PDISC,#0x00
;	../SCR/main.c:33: SCR_SCU_PAGE = 0x1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:34: SCR_SCU_RSTCON = 0x1 ; // Disable WDT and ECC reset
	mov	_SCR_SCU_RSTCON,#0x01
;	../SCR/main.c:35: SCR_SCU_STDBYWKP = 0x4; // Select WCAN as wakeup source
	mov	_SCR_SCU_STDBYWKP,#0x04
;	../SCR/main.c:51: SCR_SCU_PAGE = 1;
	mov	_SCR_SCU_PAGE,#0x01
;	../SCR/main.c:52: SCR_PMCON1 &= ~(1<< 3); // enable WCAN clock (bit_3), default: WCAN is disabled
	anl	_SCR_PMCON1,#0xF7
;	../SCR/main.c:53: SCR_SCU_PAGE = 0x2;
	mov	_SCR_SCU_PAGE,#0x02
;	../SCR/main.c:54: SCR_MODPISEL0 = 16;
	mov	_SCR_MODPISEL0,#0x10
;	../SCR/main.c:55: SCR_WCAN_PAGE = 0x0 ;
	mov	_SCR_WCAN_PAGE,#0x00
;	../SCR/main.c:56: SCR_WCAN_CFG = (1<<3)|(0<<2)|(1<<0) ; // CCE=1, SELWK_EN=0, WCAN_EN=1 --> according to UM
	mov	_SCR_WCAN_CFG,#0x09
;	../SCR/main.c:57: SCR_WCAN_INTMRSLT = (0<<3)|(1<<2)|(0<<1)|(0<<0); // WUP=0, WUF=1, ERR=0, CANTO=0 --> enable WUF interrupt
	mov	_SCR_WCAN_INTMRSLT,#0x04
;	../SCR/main.c:61: SCR_WCAN_PAGE = 0x1;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:62: SCR_WCAN_DLC_CTRL = 0x8 ; // 8 bytes of data
	mov	_SCR_WCAN_DLC_CTRL,#0x08
;	../SCR/main.c:63: SCR_WCAN_BTL1_CTRL = 0x64 ; // Configure Baud Rate of 500 kbits/s (see table 747 and register WCAN_BTL2_CTRL)
	mov	_SCR_WCAN_BTL1_CTRL,#0x64
;	../SCR/main.c:64: SCR_WCAN_BTL2_CTRL = (1<<6) | (0x33<<0) ; // BRP=01(Divide by 2) and SP=0x33 represents ~80%SP
	mov	_SCR_WCAN_BTL2_CTRL,#0x73
;	../SCR/main.c:69: SCR_WCAN_PAGE = 0x0 ;
	mov	_SCR_WCAN_PAGE,#0x00
;	../SCR/main.c:70: SCR_WCAN_CFG &= ~((1<<3)|(1<<2)|(0<<0)); // reset CCE=1, SELWK_EN=1, WCAN_EN=0 according to UM
	anl	_SCR_WCAN_CFG,#0xF3
;	../SCR/main.c:74: SCR_WCAN_PAGE = 0x2 ;
	mov	_SCR_WCAN_PAGE,#0x02
;	../SCR/main.c:75: SCR_WCAN_ID0_CTRL = 0x00;
	mov	_SCR_WCAN_ID0_CTRL,#0x00
;	../SCR/main.c:76: SCR_WCAN_ID1_CTRL = 0x00;
	mov	_SCR_WCAN_ID1_CTRL,#0x00
;	../SCR/main.c:77: SCR_WCAN_ID2_CTRL = 0x00;//0x6f ;
	mov	_SCR_WCAN_ID2_CTRL,#0x00
;	../SCR/main.c:78: SCR_WCAN_ID3_CTRL = 0x10;//0x6f ; // RTR=0 ; IDE = 0
	mov	_SCR_WCAN_ID3_CTRL,#0x10
;	../SCR/main.c:79: SCR_WCAN_MASK_ID0_CTRL = 0 ;
	mov	_SCR_WCAN_MASK_ID0_CTRL,#0x00
;	../SCR/main.c:80: SCR_WCAN_MASK_ID1_CTRL = 0 ;
	mov	_SCR_WCAN_MASK_ID1_CTRL,#0x00
;	../SCR/main.c:83: SCR_WCAN_PAGE = 0x3 ;
	mov	_SCR_WCAN_PAGE,#0x03
;	../SCR/main.c:84: SCR_WCAN_DATA7_CTRL = 0 ; // Data Frame = 0x01 23 45 67 89 ab cd ef (byte8...byte1)
	mov	_SCR_WCAN_DATA7_CTRL,#0x00
;	../SCR/main.c:85: SCR_WCAN_DATA6_CTRL = 0 ;
	mov	_SCR_WCAN_DATA6_CTRL,#0x00
;	../SCR/main.c:86: SCR_WCAN_DATA5_CTRL = 0 ;
	mov	_SCR_WCAN_DATA5_CTRL,#0x00
;	../SCR/main.c:87: SCR_WCAN_DATA4_CTRL = 0 ;
	mov	_SCR_WCAN_DATA4_CTRL,#0x00
;	../SCR/main.c:88: SCR_WCAN_DATA3_CTRL = 0 ;
	mov	_SCR_WCAN_DATA3_CTRL,#0x00
;	../SCR/main.c:89: SCR_WCAN_DATA2_CTRL = 0 ;
	mov	_SCR_WCAN_DATA2_CTRL,#0x00
;	../SCR/main.c:90: SCR_WCAN_DATA1_CTRL = 0 ;
	mov	_SCR_WCAN_DATA1_CTRL,#0x00
;	../SCR/main.c:91: SCR_WCAN_DATA0_CTRL = 0 ;
	mov	_SCR_WCAN_DATA0_CTRL,#0x00
;	../SCR/main.c:95: SCR_WCAN_PAGE = 0x0 ;
	mov	_SCR_WCAN_PAGE,#0x00
;	../SCR/main.c:96: SCR_WCAN_CFG |= ((0<<3)|(1<<2)|(0<<0)); //set CCE=0, SELWK_EN=1, WCAN_EN=0
	orl	_SCR_WCAN_CFG,#0x04
;	../SCR/main.c:97: Scr_InitCnt++;
	mov	dptr,#_Scr_InitCnt
	movx	a,@dptr
	inc	a
	movx	@dptr,a
;	../SCR/main.c:101: SCR_WCAN_PAGE = 0x1 ;
	mov	_SCR_WCAN_PAGE,#0x01
;	../SCR/main.c:102: while ((SCR_WCAN_INTESTAT0 & 0x1) != 0x1) {Scr_InitCnt++; } ; // selective wake up enable protocol handle is activated
.00101:
...
.00121:
	...
	inc	a
	movx	@dptr,a
;	../SCR/main.c:104: while(1)
	sjmp	.00101
.00105:
;	../SCR/main.c:106: Scr_Counter++;
...
;------------------------------------------------------------
;	../SCR/main.c:110: void Scr_WCAN_Interrupt(void) __interrupt (ECAN)
;	-----------------------------------------
...
_Scr_WCAN_Interrupt:
	...
	push	dpl
	push	dph
;	../SCR/main.c:112: Scr_IsrCounter1++;
	mov	dptr,#_Scr_IsrCounter1
	movx	a,@dptr
	inc	a
	movx	@dptr,a
;	../SCR/main.c:113: Scr_WakeupReason = 0x01u;
...
;------------------------------------------------------------
;	../SCR/main.c:116: void Scr_NMIECC_Interrupt(void) __interrupt (NMIRAMECC)
;	-----------------------------------------
...
_Scr_NMIECC_Interrupt:
	...
	push	dpl
	push	dph
;	../SCR/main.c:118: Scr_IsrCounter2++;
	mov	dptr,#_Scr_IsrCounter2
	movx	a,@dptr
	inc	a
	movx	@dptr,a
;	../SCR/main.c:119: Scr_WakeupReason = 0x02u;
	mov	dptr,#_Scr_WakeupReason
	mov	a,#0x02
	movx	@dptr,a
.00124:
