...
void Os_Init_C0(void)
{
    xTaskCreate(ASILD_APPL_MainCycle_Task_C0, "ASILD_APPL_MainCycle_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 51u, &ASILD_APPL_MainCycle_Task_C0_THandle);
    xTaskCreate(QM_APPL_MainCycle_Task_C0, "QM_APPL_MainCycle_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 52u, &QM_APPL_MainCycle_Task_C0_THandle);
    xTaskCreate(ASILD_BSW_Task_C0, "ASILD_BSW_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 55u, &ASILD_BSW_Task_C0_THandle);
    xTaskCreate(ASILB_BSW_Task_C0, "ASILB_BSW_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 54u, &ASILB_BSW_Task_C0_THandle);
    xTaskCreate(QM_BSW_Task_C0, "QM_BSW_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 53u, &QM_BSW_Task_C0_THandle);
...
void Os_Init_C1(void)
{
    xTaskCreate(ASILD_APPL_PreCycle_Task_C1, "ASILD_APPL_PreCycle_Task_C1", 16*configMINIMAL_STACK_SIZE, NULL, 54u, &ASILD_APPL_PreCycle_Task_C1_THandle);
    xTaskCreate(ASILD_APPL_PostCycle_Task_C1, "ASILD_APPL_PostCycle_Task_C1", 16*configMINIMAL_STACK_SIZE, NULL, 53u, &ASILD_APPL_PostCycle_Task_C1_THandle);
    xTaskCreate(ASILD_APPL_MainCycle_Task_C1, "ASILD_APPL_MainCycle_Task_C1", 16*configMINIMAL_STACK_SIZE, NULL, 52u, &ASILD_APPL_MainCycle_Task_C1_THandle);
    xTaskCreate(ASILD_BSW_Task_C1, "ASILD_BSW_Task_C1", 4*configMINIMAL_STACK_SIZE, NULL, 55u, &ASILD_BSW_Task_C1_THandle);
...
void Os_Init_C2(void)
{
    xTaskCreate(ASILC_APPL_MainCycle_Task_C2, "ASILC_APPL_MainCycle_Task_C2", 4*configMINIMAL_STACK_SIZE, NULL, 54u, NULL);
    xTaskCreate(ASILB_APPL_MainCycle_Task_C2, "ASILB_APPL_MainCycle_Task_C2", 4*configMINIMAL_STACK_SIZE, NULL, 53u, NULL);
    xTaskCreate(ASILD_BSW_Task_C2, "ASILD_BSW_Task_C2", 4*configMINIMAL_STACK_SIZE, NULL, 55u, NULL);
