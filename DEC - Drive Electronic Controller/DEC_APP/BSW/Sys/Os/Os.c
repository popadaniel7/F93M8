...
TaskHandle_t ASILD_APPL_MainCycle_Task_C0_THandle   ;
TaskHandle_t ASILB_APPL_MainCycle_Task_C2_THandle   ;
TaskHandle_t QM_APPL_MainCycle_Task_C0_THandle      ;
TaskHandle_t ASILD_BSW_Task_C0_THandle              ;
TaskHandle_t ASILD_BSW_Task_C1_THandle              ;
TaskHandle_t ASILD_BSW_Task_C2_THandle              ;
TaskHandle_t ASILB_BSW_Task_C0_THandle              ;
TaskHandle_t QM_BSW_Task_C0_THandle                 ;

void Os_Init_C0(void)
{
    xTaskCreate(ASILD_APPL_MainCycle_Task_C0, "ASILD_APPL_MainCycle_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 25u, &ASILD_APPL_MainCycle_Task_C0_THandle);

    xTaskCreate(QM_APPL_MainCycle_Task_C0, "QM_APPL_MainCycle_Task_C0", 4*configMINIMAL_STACK_SIZE, NULL, 29u, &QM_APPL_MainCycle_Task_C0_THandle);

    xTaskCreate(ASILD_BSW_Task_C0, "ASILD_BSW_Task_C0", configMINIMAL_STACK_SIZE, NULL, 28u, &ASILD_BSW_Task_C0_THandle);

    xTaskCreate(ASILB_BSW_Task_C0, "ASILB_BSW_Task_C0", configMINIMAL_STACK_SIZE, NULL, 27u, &ASILB_BSW_Task_C0_THandle);

    xTaskCreate(QM_BSW_Task_C0, "QM_BSW_Task_C0", configMINIMAL_STACK_SIZE, NULL, 26u, &QM_BSW_Task_C0_THandle);

    Handler_Alarm5ms_Callback_ASILD_APPL_MainCycle_Task_C0 = xTimerCreate("Alarm5ms_Callback_ASILD_APPL_MainCycle_Task_C0",
            pdMS_TO_TICKS(5u),
            1u,
            NULL,
            Alarm5ms_Callback_ASILD_APPL_MainCycle_Task_C0);

    Handler_Alarm5ms_Callback_ASILD_BSW_Task_C0 = xTimerCreate("Alarm5ms_Callback_ASILD_BSW_Task_C0",
            pdMS_TO_TICKS(5u),
            1u,
            NULL,
            Alarm5ms_Callback_ASILD_BSW_Task_C0);

    Handler_Alarm5ms_Callback_ASILB_BSW_Task_C0 = xTimerCreate("Alarm5ms_Callback_ASILB_BSW_Task_C0",
            pdMS_TO_TICKS(5u),
            1u,
            NULL,
            Alarm5ms_Callback_ASILB_BSW_Task_C0);

    Handler_Alarm5ms_Callback_QM_BSW_Task_C0 = xTimerCreate("Alarm5ms_Callback_QM_BSW_Task_C0",
            pdMS_TO_TICKS(5u),
            1u,
            NULL,
            Alarm5ms_Callback_QM_BSW_Task_C0);

    Handler_Alarm5ms_Callback_QM_APPL_MainCycle_Task_C0 = xTimerCreate("Alarm5ms_Callback_QM_APPL_MainCycle_Task_C0",
            pdMS_TO_TICKS(5u),
            1u,
            NULL,
            Alarm5ms_Callback_QM_APPL_MainCycle_Task_C0);

    xTimerStart(Handler_Alarm5ms_Callback_ASILD_APPL_MainCycle_Task_C0, pdMS_TO_TICKS(5u));

    xTimerStart(Handler_Alarm5ms_Callback_ASILD_BSW_Task_C0, pdMS_TO_TICKS(5u));

    xTimerStart(Handler_Alarm5ms_Callback_ASILB_BSW_Task_C0, pdMS_TO_TICKS(5u));

    xTimerStart(Handler_Alarm5ms_Callback_QM_BSW_Task_C0, pdMS_TO_TICKS(5u));

    xTimerStart(Handler_Alarm5ms_Callback_QM_APPL_MainCycle_Task_C0, 5u);
}
...
void Alarm5ms_Callback_ASILD_APPL_MainCycle_Task_C0( TimerHandle_t xTimer )
{
    ...
    vTaskResume(ASILD_APPL_MainCycle_Task_C0_THandle);
}
...
void Alarm5ms_Callback_QM_APPL_MainCycle_Task_C0( TimerHandle_t xTimer )
{
    ...
    vTaskResume(QM_APPL_MainCycle_Task_C0_THandle);
}

void Alarm5ms_Callback_ASILD_BSW_Task_C0( TimerHandle_t xTimer )
{
    Alarm5ms_Flag_ASILD_BSW_Task_C0 = 1u;
    vTaskResume(ASILD_BSW_Task_C0_THandle);
}
...
void Alarm5ms_Callback_ASILB_BSW_Task_C0( TimerHandle_t xTimer )
{
    ...
    vTaskResume(ASILB_BSW_Task_C0_THandle);
}

void Alarm5ms_Callback_QM_BSW_Task_C0( TimerHandle_t xTimer )
{
    Alarm5ms_Flag_QM_BSW_Task_C0 = 1u;
    vTaskResume(QM_BSW_Task_C0_THandle);
}
