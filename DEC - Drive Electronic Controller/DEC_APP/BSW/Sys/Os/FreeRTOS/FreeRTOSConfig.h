...
#define configMAX_TASK_NAME_LEN                    ( 254 )
...
#define configCONTEXT_INTERRUPT_PRIORITY    254
#define configTIMER_INTERRUPT_PRIORITY      255 /* This value must not be bigger then context priority */
