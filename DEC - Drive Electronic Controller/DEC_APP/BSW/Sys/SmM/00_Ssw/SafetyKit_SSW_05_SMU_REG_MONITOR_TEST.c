/**********************************************************************************************************************
 * \file SafetyKit_SSW_05_SMU_REG_MONITOR_TEST.c
...
typedef enum
{
     ...
     */
    smuRegMonitorModuleMTU = 0,             /* ALM6[0], (ALM10[21], alarm triggered during test of every module) */
    smuRegMonitorModuleIOM = 1,             /* ALM6[1], (ALM10[21], alarm triggered during test of every module) */
    smuRegMonitorModuleIR = 2,              /* ALM6[2], (ALM10[21], alarm triggered during test of every module) */
    smuRegMonitorModuleEMEM = 3,            /* ALM6[3], (ALM10[21], alarm triggered during test of every module) */
 ...
 * SM[SW]:SMU:REG_MONITOR_TEST
 * */
void safetyKitSswSmuRegMonitorTest(void)
{
    g_SafetyKitStatus.smuStatus.smuSafetyFlipFlopTriggerTestSts         = NA;
    g_SafetyKitStatus.smuStatus.smuSafetyFlipFlopTestResultCheckSts     = NA;
    g_SafetyKitStatus.smuStatus.smuSafetyFlipFlopTestAlarmFlagClearSts  = NA;
            ...
            testModeEnable++)
    {
        ...
        if(testModeEnable == smuRegMonitorModuleIOM)
        {
            continue;
        }
        else
    ...
    if(smuRegMonitorTestPassed == TRUE)
    {
        g_SafetyKitStatus.smuStatus.regMonitorTestSmu = pass;
    }
    else
    {
        g_SafetyKitStatus.smuStatus.regMonitorTestSmu = fail;
    }
}
