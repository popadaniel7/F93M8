...
#define DIAGMASTER_x70xDEFAULT 1
#define DIAGMASTER_x70xPROGRAMMING 2
#define DIAGMASTER_x70xEXTENDED 3
#define DIAGMASTER_x70xCODING 4
#define DIAGMASTER_x70xCALIBRATION 5
