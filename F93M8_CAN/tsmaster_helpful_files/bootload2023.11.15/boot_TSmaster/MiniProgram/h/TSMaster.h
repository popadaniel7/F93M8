...
typedef s32 (__stdcall* TIniReadStringWoQuotes)(const s32 AHandle, const char* ASection, const char* AKey, const char* AValue, ps32 AValueCapacity, const char* ADefault);
...
typedef s32 (__stdcall* TSignalTesterGetItemResultByName)(const void* AObj, const char* AName, pbool AIsPass, ps64 AEventTimeUs, char** ADescription);
typedef s32 (__stdcall* TSignalTesterGetItemResultByIndex)(const void* AObj, const s32 AIndex, pbool AIsPass, ps64 AEventTimeUs, char** ADescription);
typedef s32 (__stdcall* TSignalTesterGetItemVerdictByName)(const void* AObj, const char* AName, pbool AIsPass);
typedef s32 (__stdcall* TSignalTesterCheckStatisticsByIndex)(const void* AObj, const s32 AIndex, const double AMin, const double AMax, bool* APass, pdouble AResult, char** AResultRepr);
typedef s32 (__stdcall* TSignalTesterCheckStatisticsByName)(const void* AObj, const char* AItemName, const double AMin, const double AMax, bool* APass, pdouble AResult, char** AResultRepr);
...
typedef struct _TTSTest {
    ...
    s32 signal_tester_get_item_result_by_name(const char* AName, pbool AIsPass, ps64 AEventTimeUs, char** ADescription){
        return internal_signal_tester_get_item_result_by_name(FObj, AName, AIsPass, AEventTimeUs, ADescription);
    }
    s32 signal_tester_get_item_result_by_index(const s32 AIndex, pbool AIsPass, ps64 AEventTimeUs, char** ADescription){
        return internal_signal_tester_get_item_result_by_index(FObj, AIndex, AIsPass, AEventTimeUs, ADescription);
    }
    ...
    s32 signal_tester_check_statistics_by_index(const s32 AIndex, const double AMin, const double AMax, bool* APass, pdouble AResult, char** AResultRepr){
        return internal_signal_tester_check_statistics_by_index(FObj, AIndex, AMin, AMax, APass, AResult, AResultRepr);
    }
    s32 signal_tester_check_statistics_by_name(const char* AItemName, const double AMin, const double AMax, bool* APass, pdouble AResult, char** AResultRepr){
        return internal_signal_tester_check_statistics_by_name(FObj, AItemName, AMin, AMax, APass, AResult, AResultRepr);
    }
}TTSTest, * PTSTest;
...
#define IDX_ETH_GENERIC_ACK                                234  /* Generic ACK of DOIP Frame */
#define IDX_ETH_VEHILCE_INFO_RES                           235  /* Response of Vehicle Information */
#define IDX_ETH_ACTIVATE_RES                               236  /* Response of Active Request */
#define IDX_ETH_ALIVE_RES                                  237  /* Response of Alive Request */
#define IDX_ETH_NODE_STATE_RES                             238  /* Response of Node State */
#define IDX_ETH_DIAG_POWER_MODE_RES                        239  /* Response of Diagnostic Power Mode */
#define IDX_ETH_DIAG_POSITIVE_ACK                          240  /* Positive ACK of Diagnostic Request */
#define IDX_ETH_DIAG_NEGATIVE_ACK                          241  /* Negative ACK of Diagnostic Request */
#define IDX_ETH_VEHICLE_REQ_ID                             242  /* Vehicle ID Request */
#define IDX_ETH_VEHICLE_REQ_EID_ID                         243  /* Vehicle ID with EID Request */
#define IDX_ETH_VEHICLE_REQ_VIN_ID                         244  /* Vehicle ID with VIN Request */
#define IDX_ETH_ACTIVE_REQ                                 245  /* Routing Activation Request */
#define IDX_ETH_ALIVE_REQ                                  246  /* Alive Check Request */
#define IDX_ETH_NODE_STATE_REQ                             247  /* Node State Request */
#define IDX_ETH_DIAG_POWER_MODE_REQ                        248  /* Diagnostic Power Mode Request */
