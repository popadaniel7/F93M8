...
static int L_Data_request(can_iso_tp_link_t_p link_src, const struct CAN_msg* msg)
{
 ...
 LinkTxPoint=link_src;
 msgPublic=*msg;
 for(uint8_t i=0;i<dlc2len(msg->dlc);i++)
 {
  Tx_buffer[i]=msg->data[i];
 }
