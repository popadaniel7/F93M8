# 1 "RTE/Device/TLE9893_2QKW62S/uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/uart.c" 2
# 32 "RTE/Device/TLE9893_2QKW62S/uart.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/uart.h" 1
# 103 "./RTE/Device/TLE9893_2QKW62S/uart.h"
...
# 104 "./RTE/Device/TLE9893_2QKW62S/uart.h" 2
...
#pragma clang diagnostic pop
# 105 "./RTE/Device/TLE9893_2QKW62S/uart.h" 2
...
# 106 "./RTE/Device/TLE9893_2QKW62S/uart.h" 2
...
# 108 "./RTE/Device/TLE9893_2QKW62S/uart.h" 2
# 1 "./RTE/Device/TLE9893_2QKW62S/isr_defines.h" 1
# 109 "./RTE/Device/TLE9893_2QKW62S/uart.h" 2
...
# 33 "RTE/Device/TLE9893_2QKW62S/uart.c" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/uart.c" 2
# 51 "RTE/Device/TLE9893_2QKW62S/uart.c"
typedef union UARTx_BCON
{
  ...
  struct {
    ...
    uint32_t BR_PRE : 3;
    uint32_t : 9;
    uint32_t BG_FD_SEL : 5;
    uint32_t BG_BR_VALUE : 11;
  } bit;
} tUARTx_BCON;
# 84 "RTE/Device/TLE9893_2QKW62S/uart.c"
sint8 UARTx_setBaudrate(uint32 u32_baudrate, volatile tUARTx_BCON *tp_baudrateReg);
# 94 "RTE/Device/TLE9893_2QKW62S/uart.c"
sint8 UART0_init(void)
{
  sint8 s8_returnCode;
  s8_returnCode = (-116);
# 110 "RTE/Device/TLE9893_2QKW62S/uart.c"
  return s8_returnCode;
}
...
sint8 UART1_init(void)
{
  sint8 s8_returnCode;
  s8_returnCode = (-116);
# 135 "RTE/Device/TLE9893_2QKW62S/uart.c"
  return s8_returnCode;
}
# 146 "RTE/Device/TLE9893_2QKW62S/uart.c"
uint32 UART0_getBaudrate(void)
{
  return (uint32)(((0x50u) * 1000000 * 2 ) / ((1U << (uint8)((UART0_Type*) 0x48018000UL)->BCON.bit.BR_PRE) * (32 * ((UART0_Type*) 0x48018000UL)->BCON.bit.BG_BR_VALUE + (((UART0_Type*) 0x48018000UL)->BCON.bit.BG_FD_SEL))));
}
# 160 "RTE/Device/TLE9893_2QKW62S/uart.c"
uint32 UART1_getBaudrate(void)
{
  return (uint32)(((0x50u) * 1000000 * 2 ) / ((1U << (uint8)((UART1_Type*) 0x4801C000UL)->BCON.bit.BR_PRE) * (32 * ((UART1_Type*) 0x4801C000UL)->BCON.bit.BG_BR_VALUE + (((UART1_Type*) 0x4801C000UL)->BCON.bit.BG_FD_SEL))));
}
# 174 "RTE/Device/TLE9893_2QKW62S/uart.c"
sint8 UARTx_setBaudrate(uint32 u32_baudrate, volatile tUARTx_BCON *tp_baudrateReg)
{
  sint8 s8_returnCode;
  ...
  u32_maxBaudrate = (uint32)((0x50u) * 1000000 / 16);
  ...
  if ((u32_baudrate <= u32_maxBaudrate) && (u32_baudrate >= 2400u))
  {
    ...
    while (u8_prescaler > 0u && u8_deviation < 250)
    {
      ...
      u16_reloadVal = (uint16)((uint32)(0x50u) * 1000000u / (16u * u8_prescaler * u32_baudrate));
      ...
      if ((u16_reloadVal <= 2047u) && (u16_reloadVal > 0u))
      {
        ...
        for (i = 0; i <= 32; i++)
        {
          ...
          u32_calcBR = ((0x50u) * 1000000u * 32u) / (16u * u8_prescaler * (32u * u16_reloadVal + i));
...
sint8 UART0_setBaudrate(uint32 u32_baudrate)
{
  ...
  u32_addr = (uint32)&((UART0_Type*) 0x48018000UL)->BCON.reg;
...
sint8 UART1_setBaudrate(uint32 u32_baudrate)
{
  ...
  u32_addr = (uint32)&((UART1_Type*) 0x4801C000UL)->BCON.reg;
  tp_baudrateReg = (tUARTx_BCON *) u32_addr;
...
# 450 "RTE/Device/TLE9893_2QKW62S/uart.c"
