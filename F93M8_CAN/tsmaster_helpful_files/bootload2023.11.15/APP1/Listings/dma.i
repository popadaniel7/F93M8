# 1 "RTE/Device/TLE9893_2QKW62S/dma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/dma.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/dma.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/dma.h" 1
# 77 "./RTE/Device/TLE9893_2QKW62S/dma.h"
...
# 78 "./RTE/Device/TLE9893_2QKW62S/dma.h" 2
...
#pragma clang diagnostic pop
# 79 "./RTE/Device/TLE9893_2QKW62S/dma.h" 2
...
# 80 "./RTE/Device/TLE9893_2QKW62S/dma.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/dma.c" 2

# 1 "./RTE/Device/TLE9893_2QKW62S/scu_defines.h" 1
# 36 "RTE/Device/TLE9893_2QKW62S/dma.c" 2
# 69 "RTE/Device/TLE9893_2QKW62S/dma.c"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wmissing-variable-declarations"
#pragma clang diagnostic ignored "-Wunreachable-code"
#pragma clang diagnostic ignored "-Wpedantic"
#pragma clang diagnostic ignored "-Wcovered-switch-default"
# 701 "RTE/Device/TLE9893_2QKW62S/dma.c"
sint8 DMA_init(void)
{
  sint8 s8_returnCode;
  s8_returnCode = (-116);
# 1125 "RTE/Device/TLE9893_2QKW62S/dma.c"
  return s8_returnCode;
}
# 1137 "RTE/Device/TLE9893_2QKW62S/dma.c"
void DMA_setBasicTransfer(uint8 u8_chIdx, uint32 u32_srcAddr, uint32 u32_dstAddr, uint32 u32_transferCnt, tDMA_transferSize e_transferSize, tDMA_incrementMode e_incrementMode)
{
  tDMA_entry *s_entry;
  uint32 u32_startAddress;

  u32_startAddress = u8_chIdx * sizeof(tDMA_entry) + 0x18007B00u;
  ...
  ((DMA_Type*) 0x48034000UL)->CTRL_BASE_PTR.reg = 0x18007B00u;

  ((DMA_Type*) 0x48034000UL)->CHNL_ENABLE_SET.reg |= ((uint32)1u << u8_chIdx);
}
...
void DMA_setMemSctGth(uint8 u8_chIdx, tDMA_entry *s_taskList, uint32 u32_taskCnt)
{
  ...
  s_entry->u32_dstEndPtr = (((DMA_Type*) 0x48034000UL)->ALT_CTRL_BASE_PTR.reg + (u8_chIdx * sizeof(tDMA_entry))) + 12u;
...
# 1329 "RTE/Device/TLE9893_2QKW62S/dma.c"
tDMA_entry *DMA_setPrimaryTaskSctGth(tDMA_entry *s_primEntry, uint8 u8_chIdx, tDMA_entry *s_taskList, uint32 u32_taskCnt)
{
  ...
  s_primEntry->u32_dstEndPtr = (((DMA_Type*) 0x48034000UL)->ALT_CTRL_BASE_PTR.reg + (u8_chIdx * sizeof(tDMA_entry))) + 12u;
...
# 1365 "RTE/Device/TLE9893_2QKW62S/dma.c"
tDMA_entry *DMA_setTaskSctGth(tDMA_entry *s_entry, tDMA_cycleType e_cycleType, uint8 u8_Rpower, uint32 u32_srcAddr, uint32 u32_dstAddr, uint32 u32_transferCnt, tDMA_transferSize e_transferSize, tDMA_incrementMode e_incrementMode)
{
