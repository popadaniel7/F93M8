...
{	
 ...
 CANMSGOBJ0->CAN_MOFGPR8.bit.BOT =  12; // MO_12
 CANMSGOBJ0->CAN_MOFGPR8.bit.CUR =  8;  // MO_8
 CANMSGOBJ0->CAN_MOFGPR8.bit.TOP =  13; // MO_13
...
//		 CAN_TransmitReqMsgObj2(CANMSGOBJ1->CAN_EMO9DATA0.reg, CANMSGOBJ1->CAN_EMO9DATA1.reg);
		 /* check for data consistency */
