# 1 "RTE/Device/TLE9893_2QKW62S/int.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/int.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/int.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/int.h" 1
# 91 "./RTE/Device/TLE9893_2QKW62S/int.h"
...
# 92 "./RTE/Device/TLE9893_2QKW62S/int.h" 2
...
# 93 "./RTE/Device/TLE9893_2QKW62S/int.h" 2

# 1 "./RTE/Device/TLE9893_2QKW62S/isr_defines.h" 1
# 95 "./RTE/Device/TLE9893_2QKW62S/int.h" 2
# 1 "./RTE/Device/TLE9893_2QKW62S/ccu7_defines.h" 1
# 96 "./RTE/Device/TLE9893_2QKW62S/int.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/int.c" 2
# 58 "RTE/Device/TLE9893_2QKW62S/int.c"
void INT_init(void)
{

  ((BDRV_Type*) 0x4000C000UL)->IRQCLR.reg = (uint32)0xFF333333u;
  ((PMU_Type*) 0x48000000UL)->VDDC_STS_CLR.reg = (uint32)0x3u;
  ((PMU_Type*) 0x48000000UL)->VDDEXT_STS_CLR.reg = (uint32)0x3u;
  ((PMU_Type*) 0x48000000UL)->VDDP_STS_CLR.reg = (uint32)0x3u;
  ((CANTRX_Type*) 0x4800C000UL)->IRQCLR.reg = (uint32)0xFu;
  ((ARVG_Type*) 0x48038000UL)->VAREF_IRQ_CLR.reg = (uint32)0x1u;
  ((CSACSC_Type*) 0x40010000UL)->IRQCLR.reg = (uint32)0x3u;
  ((SCU_Type*) 0x48004000UL)->INP0.reg = (uint32)(0x0u);
  ((BDRV_Type*) 0x4000C000UL)->IRQEN.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->VDDC_IRQEN.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->VDDEXT_IRQEN.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->VDDP_IRQEN.reg = (uint32)(0x0u);
  ((CANTRX_Type*) 0x4800C000UL)->IRQEN.reg = (uint32)(0x0u);
  ((ARVG_Type*) 0x48038000UL)->VAREF_IEN.reg = (uint32)(0x0u);
  ((CSACSC_Type*) 0x40010000UL)->IRQEN.reg = (uint32)(0x0u);

  ((SCU_Type*) 0x48004000UL)->EXTISC.reg = (uint32)0xFFu;
  ((SCU_Type*) 0x48004000UL)->INP4.reg = (0x0u);
  ((SCU_Type*) 0x48004000UL)->EXTCON.reg = (uint32)(0x0u);
  ((SCU_Type*) 0x48004000UL)->EXTIEN.reg = (0x0u);

  ((SCU_Type*) 0x48004000UL)->NMISRC.reg = (uint32)0x7u;
  ((MEMCTRL_Type*) 0x48044000UL)->NMISRC.reg = (uint32)0x1FFu;
  ((SCU_Type*) 0x48004000UL)->NMICON.reg = (uint32)(0x0u);
  ((MEMCTRL_Type*) 0x48044000UL)->NMICON.reg = (uint32)(0x0u);

  ((SCU_Type*) 0x48004000UL)->MONISC.reg = (uint32)0x3Fu;
  ((SCU_Type*) 0x48004000UL)->INP2.reg = (0x00u);
  ((SCU_Type*) 0x48004000UL)->MONIEN.reg = (uint32)(0x03u);
  ((SCU_Type*) 0x48004000UL)->MONCON.reg = (uint32)(0x0Fu);
# 99 "RTE/Device/TLE9893_2QKW62S/int.c"
  ((ADC1_Type*) 0x40000000UL)->INP0.reg = (uint32)(0x0u);
  ((ADC1_Type*) 0x40000000UL)->INP1.reg = (uint32)(0x0u);
  ((ADC1_Type*) 0x40000000UL)->INP2.reg = (uint32)(0x0u);
  ((ADC1_Type*) 0x40000000UL)->INP3.reg = (uint32)(0x0u);
  ((ADC1_Type*) 0x40000000UL)->CHSTATCLR.reg = (uint32)0xFFFFFu;
  ((ADC1_Type*) 0x40000000UL)->SQSTATCLR.reg = (uint32)0xFFFu;
  ((ADC1_Type*) 0x40000000UL)->FILSTATCLR.reg = (uint32)0xFu;
  ((ADC1_Type*) 0x40000000UL)->CMPSTATCLR.reg = (uint32)0xFF00FFu;
  ((ADC1_Type*) 0x40000000UL)->IEN0.reg = (uint32)(0x0u);
  ((ADC1_Type*) 0x40000000UL)->IEN1.reg = (uint32)(0x0u);

  ((ADC2_Type*) 0x4804C000UL)->INP0.reg = (uint32)(0x0u);
  ((ADC2_Type*) 0x4804C000UL)->INP2.reg = (uint32)(0x0u);
  ((ADC2_Type*) 0x4804C000UL)->INP3.reg = (uint32)(0x0u);
  ((ADC2_Type*) 0x4804C000UL)->CHSTATCLR.reg = (uint32)0x3FFFu;
  ((ADC2_Type*) 0x4804C000UL)->SQSTATCLR.reg = (uint32)0xFu;
  ((ADC2_Type*) 0x4804C000UL)->FILSTATCLR.reg = (uint32)0xFFu;
  ((ADC2_Type*) 0x4804C000UL)->CMPSTATCLR.reg = (uint32)0xFFFFFFFFu;
  ((ADC2_Type*) 0x4804C000UL)->IEN0.reg = (uint32)(0x0u);
  ((ADC2_Type*) 0x4804C000UL)->IEN1.reg = (uint32)(0x0u);

  ((CCU7_Type*) 0x40008000UL)->ISR.reg = (uint32)0x0000F7FFu;
  ((CCU7_Type*) 0x40008000UL)->ISR_2.reg = (uint32)0x00003F3Fu;
  ((CCU7_Type*) 0x40008000UL)->IGT.reg = (uint32)(0x0u);
  ((CCU7_Type*) 0x40008000UL)->INP.reg = (uint32)(0x0u);
  ((CCU7_Type*) 0x40008000UL)->IEN.reg = (uint32)(0x0u);
  ((CCU7_Type*) 0x40008000UL)->INP_2.reg = (uint32)(0x0u);
  ((CCU7_Type*) 0x40008000UL)->IEN_2.reg = (uint32)(0x2000u);
  ((CCU7_Type*) 0x40008000UL)->LI.reg = (uint32)(0x0u) & (uint32)0xE000u;

  ((BDRV_Type*) 0x4000C000UL)->BEMFC_IRQCLR.reg = (uint32)0x3Fu;
  ((SCU_Type*) 0x48004000UL)->INP3.reg = (uint32)(0x0u);
  ((BDRV_Type*) 0x4000C000UL)->BEMFC_IRQEN.reg = (uint32)(0x0u);

  ((SDADC_Type*) 0x40004000UL)->ISR.reg = (uint32)0x77u;
  ((SDADC_Type*) 0x40004000UL)->IEN.reg = (0x0u);


  ((SCU_Type*) 0x48004000UL)->GPTISC.reg = (uint32)0x3Fu;
  ((SCU_Type*) 0x48004000UL)->INP1.reg = (uint32)(0x0u);
  ((SCU_Type*) 0x48004000UL)->GPTIEN.reg = (uint32)(0x0u);

  ((SSC0_Type*) 0x48020000UL)->ISC.reg = (uint32)0x3Fu;
  ((SSC1_Type*) 0x48024000UL)->ISC.reg = (uint32)0x3Fu;
  ((SCU_Type*) 0x48004000UL)->INP6.reg = (uint32)(0x0u);
  ((SSC0_Type*) 0x48020000UL)->IEN.reg = (uint32)(0x0u);
  ((SSC1_Type*) 0x48024000UL)->IEN.reg = (uint32)(0x0u);

  ((T20_Type*) 0x48028000UL)->ICLR.reg = (uint32)0xC0u;
  ((T21_Type*) 0x4802C000UL)->ICLR.reg = (uint32)0xC0u;

  ((T20_Type*) 0x48028000UL)->CON1.reg = (uint32)(0x0u);
  ((T21_Type*) 0x4802C000UL)->CON1.reg = (uint32)(0x0u);

  ((UART0_Type*) 0x48018000UL)->ISC.reg = (uint32)0x303u;
  ((UART1_Type*) 0x4801C000UL)->ISC.reg = (uint32)0x303u;
  ((SCU_Type*) 0x48004000UL)->INP5.reg = (uint32)(0x0u);
  ((UART0_Type*) 0x48018000UL)->IEN.reg = (0x0u);
  ((UART1_Type*) 0x4801C000UL)->IEN.reg = (0x0u);

  ((SCU_Type*) 0x48004000UL)->DMAISC.reg = (uint32)0xFFu;
  ((SCU_Type*) 0x48004000UL)->INP7.reg = (uint32)(0x0u);
  ((SCU_Type*) 0x48004000UL)->DMAIEN.reg = (uint32)(0x0u);

  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR0.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR1.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR2.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR3.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR4.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR5.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR6.reg = (0xF00000u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_IPR7.reg = (0x0u);
  ((CPU_Type*) 0xE000E000UL)->NVIC_ISER.reg = (0x21541045u);
}
