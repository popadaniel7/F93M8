...
int main(void)
{
  ...
  if(((PMU_Type*) 0x48000000UL)->GPUDATA2.reg==0xee)
  {
   ...
   ((PMU_Type*) 0x48000000UL)->WD_CTRL.bit.EN=1;
  ...
  else
  {
   ...
   if(((PMU_Type*) 0x48000000UL)->GPUDATA2.reg==0xdd)
   {
    ...
    if(((*((uint32_t *)0x11005F80))==0x55)&&((*((uint32_t *)0x11005F84))==crc32((uint8_t *)((*((uint32_t *)0x11005F88))),(*((uint32_t *)0x11005F8c)))))
    {
...
# 117 "app/main.c"
  ...
  while(1)
  {
   ...
   {
    tick_diff = last_sys_tick + 120*60000 - tick_now;
   }

   if(tick_diff > 60000)
   {
    uint32 ms_add = tick_diff/60000;
    ...
    if(last_sys_tick<ms_add*60000)
    {
     last_sys_tick =last_sys_tick+120*60000 -ms_add*60000;
    }
    else
    {
     last_sys_tick -=ms_add*60000;
    }
    }
   else
   {
   ...
   if((((PMU_Type*) 0x48000000UL)->GPUDATA2.reg!=0xcc)&&(sclock_count>=50)&&(can_receive_counter==0))
   {
