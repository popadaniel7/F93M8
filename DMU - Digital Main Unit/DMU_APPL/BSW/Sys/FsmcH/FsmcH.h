...
#define FSMCH_Ax            18
#define FSMCH_NEx           1
#define FSMCH_ADDRESS  		(0x60000000 + ((FSMCH_NEx-1) << 26))
#define FSMCH_LCD_CMD_ADDR  (FSMCH_ADDRESS)
#define FSMCH_LCD_DATA_ADDR (FSMCH_ADDRESS | 1 << (FSMCH_Ax + 1))
#define FSMCH_LCD_CMD       (*((volatile uint16*) FSMCH_LCD_CMD_ADDR))
#define FSMCH_LCD_DATA      (*((volatile uint16*) FSMCH_LCD_DATA_ADDR))
#define FSMCH_LCD_WIDTH 	320
#define FSMCH_LCD_HEIGHT	240
...
extern void FsmcH_WriteData(uint16 data);
extern void FsmcH_WriteCommand(uint16 command);
extern void FsmcH_SetArea(uint16 xStart, uint16 yStart, uint16 xEnd, uint16 yEnd);
extern void FsmcH_FillRectangle(uint16 xStart, uint16 yStart, uint16 width, uint16 height, uint16 color);
extern void FsmcH_DrawHLine(uint16 x, uint16 y, uint16 width, uint16 color);
extern void FsmcH_DrawVLine(uint16 x, uint16 y, uint16 height, uint16 color);
extern void FsmcH_DrawRectangle(uint16 x, uint16 y, uint16 width, uint16 height, uint16 color);
extern void FsmcH_DrawPixel(uint16 x, uint16 y, uint16 color);
extern void FsmcH_DrawChar(uint16 x, uint16 y, char c, uint16 color, uint16 bgcolor);
extern void FsmcH_DrawString(uint16 x, uint16 y, char* str, uint16 color, uint16 bgcolor);
extern void FsmcH_DrawInteger(uint16 x, uint16 y, uint32 num, uint16 color, uint16 bgcolor);
extern void FsmcH_DrawString8(uint16 x, uint16 y, char* str, uint16 color, uint16 bgcolor);
extern void FsmcH_DrawChar8(uint16 x, uint16 y, char c, uint16 color, uint16 bgcolor);
extern uint32 FsmcH_ReadData(void);
extern uint16* FsmcH_GetDrawAddress(void);
extern uint8 FsmcH_LcdInit(void);
extern void FsmcH_MainFunction(void);
