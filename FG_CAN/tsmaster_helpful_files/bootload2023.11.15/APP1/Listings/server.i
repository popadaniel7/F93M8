...
static void UDS_Serice_DiagnosticSessionControl(void)
{
 ...
 if(0x02==DataLength)
 {
   ...
   *((uint8_t *)0x18000000)=0x22;
   ...
   if(ServerData.rxMsgData[1]==0x03)
   {
    ((PMU_Type*) 0x48000000UL)->GPUDATA1.reg =0XDD;
    ((PMU_Type*) 0x48000000UL)->GPUDATA0.reg=0X11;

    ((PMU_Type*) 0x48000000UL)->GPUDATA2.reg=0xee;


    if(((PMU_Type*) 0x48000000UL)->GPUDATA2.reg==0xee)
    {
     __NVIC_SystemReset();
    }
        else
...
# 328 "Uds_server/server.c"
uint32_t UDS27_Timelock_count=1000;

uint8_t SecurityAccess_STATION=0xf0;
# 793 "Uds_server/server.c"
uint32_t Serive_Online=0;

static void UDS_Serice_TesterPresent(void)
{
 if (0x3E==ServerData.rxMsgData[1])
 {
  Serive_Online=5000;
 }
 else
