# 1 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c"
...
#pragma clang diagnostic pop
# 34 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c" 2
...
# 35 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c" 2
...
# 36 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c" 2
...
# 54 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c"
void HardFault_Handler(void)
{
...
void NMI_Handler(void)
{
# 344 "RTE/Device/TLE9893_2QKW62S/isr_exceptions.c"
}
...
{
 if(60000 == ((CPU_Type*) 0xE000E000UL)->SYSTICK_RL.reg)
 {
  ((CPU_Type*) 0xE000E000UL)->SYSTICK_RL.reg = 120*60000;
  u32_globTimestamp_ms++;
  PMU_countFailSafeWatchdog();
 }
 else
