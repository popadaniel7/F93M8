# 1 "RTE/Device/TLE9893_2QKW62S/gpt12.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/gpt12.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/gpt12.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/gpt12.h" 1
# 101 "./RTE/Device/TLE9893_2QKW62S/gpt12.h"
...
# 102 "./RTE/Device/TLE9893_2QKW62S/gpt12.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/gpt12.c" 2
# 59 "RTE/Device/TLE9893_2QKW62S/gpt12.c"
sint8 GPT12_init(void)
{
  sint8 s8_returnCode;
  s8_returnCode = (-116);
# 81 "RTE/Device/TLE9893_2QKW62S/gpt12.c"
...
sint8 GPT12_setIntervalTimerT3(uint32 u32_timeInterval_us)
{
  ...
  u64_timeInterval_ticks = (uint64)(((uint64)u32_timeInterval_us * (uint64)(0x7270E0u))/(uint64)1000000U);
  ...
  if (u8_T3ClkPrescaler <= 7u)
  {
    ...
    ((GPT12_Type*) 0x40014000UL)->T3CON.bit.T3M = 0u;

    ((GPT12_Type*) 0x40014000UL)->T3CON.bit.T3I = (uint8)u8_T3ClkPrescaler;

    ((GPT12_Type*) 0x40014000UL)->T3CON.bit.T3UDE = 0u;

    ((GPT12_Type*) 0x40014000UL)->T3CON.bit.T3UD = 1u;

    ((GPT12_Type*) 0x40014000UL)->T3.bit.T3 = (uint16)u64_timeInterval_ticks;

    ((GPT12_Type*) 0x40014000UL)->T2CON.bit.T2M = 4u;

    ((GPT12_Type*) 0x40014000UL)->T2.bit.T2 = (uint16)u64_timeInterval_ticks;

    ((GPT12_Type*) 0x40014000UL)->T3CON.bit.T3OTL = 1u;

    ((GPT12_Type*) 0x40014000UL)->T2CON.bit.T2I = 7u;
  }
  else
  {
    s8_returnCode = (-122);
...
sint8 GPT12_setIntervalTimerT6(uint32 u32_timeInterval_us)
{
  ...
  u64_timeInterval_ticks = (uint64)(((uint64)u32_timeInterval_us * (uint64)(0xE4E1C0u))/(uint64)1000000U);
  ...
  if (u8_T6ClkPrescaler <= 7u)
  {
    ...
    ((GPT12_Type*) 0x40014000UL)->T6CON.bit.T6M = 0u;

    ((GPT12_Type*) 0x40014000UL)->T6CON.bit.T6I = (uint8)u8_T6ClkPrescaler;

    ((GPT12_Type*) 0x40014000UL)->T6CON.bit.T6UDE = 0u;

    ((GPT12_Type*) 0x40014000UL)->T6CON.bit.T6UD = 1u;

    ((GPT12_Type*) 0x40014000UL)->T6.bit.T6 = (uint16)u64_timeInterval_ticks;

    ((GPT12_Type*) 0x40014000UL)->CAPREL.bit.CAPREL = (uint16)u64_timeInterval_ticks;

    ((GPT12_Type*) 0x40014000UL)->T6CON.bit.T6OTL = 1u;

    ((GPT12_Type*) 0x40014000UL)->T6CON.bit.T6SR = 1u;
  }
  else
  {
    s8_returnCode = (-122);
