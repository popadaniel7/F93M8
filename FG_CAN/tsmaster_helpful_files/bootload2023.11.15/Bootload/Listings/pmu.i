# 1 "RTE/Device/TLE9893_2QKW62S/pmu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/pmu.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/pmu.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/pmu.h" 1
# 139 "./RTE/Device/TLE9893_2QKW62S/pmu.h"
...
# 140 "./RTE/Device/TLE9893_2QKW62S/pmu.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/pmu.c" 2
# 51 "RTE/Device/TLE9893_2QKW62S/pmu.c"
volatile uint32 u32_failsafeWatchdogCnt;
static _Bool b_SOWactive = 0;
static _Bool b_firstNOW = 0;
# 67 "RTE/Device/TLE9893_2QKW62S/pmu.c"
sint8 PMU_init(void)
{
  sint8 s8_returnCode;
  ...
  ((PMU_Type*) 0x48000000UL)->START_CONFIG.reg = (uint32)(0x2u);


  ((PMU_Type*) 0x48000000UL)->MISC_CTRL.reg = (uint32)(0x0u);
# 86 "RTE/Device/TLE9893_2QKW62S/pmu.c"
  ((PMU_Type*) 0x48000000UL)->RST_CTRL.reg = (uint32)(0x7u);



  if (((PMU_Type*) 0x48000000UL)->WAKE_FAIL_STS.reg != (uint32)0u)
  {
    s8_returnCode = (-1);
  }
  ...
  ((PMU_Type*) 0x48000000UL)->VDDP_CTRL.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->VDDC_CTRL.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->VDDEXT_CTRL.reg = (uint32)(0x1u);

  ((PMU_Type*) 0x48000000UL)->WAKE_FILT_CTRL.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->WAKE_GPIO_CTRL0.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->WAKE_GPIO_CTRL1.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->WAKE_GPIO_CTRL2.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->WAKE_GPIO_CTRL3.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->WAKE_GPIO_CTRL4.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->WAKE_GPIO_CTRL5.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->MON_CTRL1.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->MON_CTRL2.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->MON_CTRL3.reg = (uint32)(0x0u);
  ((PMU_Type*) 0x48000000UL)->CYC_CTRL.reg = (uint32)(0x38380000u);
  ((PMU_Type*) 0x48000000UL)->WAKE_CTRL.reg = (uint32)(0x20000000u);
...
sint8 PMU_initFailSafeWatchdog(void)
{
  ...
  while (u32_failsafeWatchdogCnt < u32_maxDelay_ms)
  {
    if (PMU_getWDFailSts() == 1u)
    {
      ...
      ((PMU_Type*) 0x48000000UL)->WD_CTRL.bit.WDP = (uint8)(((uint32)(0x3F0000u) & (0x3f0000UL)) >> (16UL));

      ((PMU_Type*) 0x48000000UL)->WD_CTRL.bit.SOW = (uint8)(((uint32)(0x3F0000u) & (0x3000000UL)) >> (24UL));

      ((PMU_Type*) 0x48000000UL)->WD_TRIG.bit.TRIG ^= 1u;
...
void PMU_stopFailSafeWatchdog(void)
{
  ...
  ((CPU_Type*) 0xE000E000UL)->SYSTICK_CS.bit.ENABLE = 0u;
}
...
sint8 PMU_serviceFailSafeWatchdog(void)
{
  ...
  if ((u32_failsafeWatchdogCnt > (0x2D1u)) || (b_SOWactive == 1))
  {
    ...
    if (b_firstNOW == 0)
    {
      ...
      ((PMU_Type*) 0x48000000UL)->FS_STS_CLR.bit.WD_FAIL_STS_CLR = (uint8)1;

      ((PMU_Type*) 0x48000000UL)->FS_SSD_CLR.reg = (uint32)((0x1UL) | (0x2UL));
...
void PMU_clrFailSafeWatchdogFailSts(void)
{
  while (((PMU_Type*) 0x48000000UL)->FS_STS.bit.WD_FAIL_STS == 1u)
  {
    if (PMU_serviceFailSafeWatchdog() == 0)
    {
      ((PMU_Type*) 0x48000000UL)->FS_STS_CLR.bit.WD_FAIL_STS_CLR = 1u;
    }
  }
...
sint8 PMU_serviceFailSafeWatchdogSOW(void)
{
  ...
  if (((PMU_Type*) 0x48000000UL)->WD_CTRL.bit.SOW != 0u)
  {
    ((PMU_Type*) 0x48000000UL)->WD_TRIG_SOW.bit.TRIG ^= 1u;
    b_SOWactive = 1;
  }
  else
  {
...
# 259 "RTE/Device/TLE9893_2QKW62S/pmu.c"
