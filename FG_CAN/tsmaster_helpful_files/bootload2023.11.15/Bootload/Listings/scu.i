# 1 "RTE/Device/TLE9893_2QKW62S/scu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/scu.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/scu.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/scu.h" 1
# 132 "./RTE/Device/TLE9893_2QKW62S/scu.h"
...
# 133 "./RTE/Device/TLE9893_2QKW62S/scu.h" 2
...
#pragma clang diagnostic pop
# 134 "./RTE/Device/TLE9893_2QKW62S/scu.h" 2
...
# 135 "./RTE/Device/TLE9893_2QKW62S/scu.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/scu.c" 2
# 48 "RTE/Device/TLE9893_2QKW62S/scu.c"
sint8 e_xtalSts;
# 60 "RTE/Device/TLE9893_2QKW62S/scu.c"
void SCU_init(void)
{

  ((SCU_Type*) 0x48004000UL)->CLKSEL.reg |= ((uint32)(0x9000Eu) & (0x80000UL));
}
# 79 "RTE/Device/TLE9893_2QKW62S/scu.c"
sint8 SCU_initClk(void)
{
  sint8 s8_returnCode;
  uint8 u8_nmiEnTemp;
  ...
  ((SCU_Type*) 0x48004000UL)->CLKSEL.reg = 0x00000000u;
  ((PLL_Type*) 0x48008000UL)->CON0.bit.PLLEN = 0;
  ((PLL_Type*) 0x48008000UL)->CON1.bit.PLLEN = 0;
  ((SCU_Type*) 0x48004000UL)->XTALCON.reg = 0x00000033u;
  ...
  if (((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIXTALEN == 1u)
  {
    ((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIXTALEN = 0;
    u8_nmiEnTemp = 1u;
  }


  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.reg |= 0x3;

  ((SCU_Type*) 0x48004000UL)->XTALCON.reg = (0x1000002u);
  u32_endTime_ms = INT_getGlobTimestamp() + (0x2u);
  ...
  ((SCU_Type*) 0x48004000UL)->XTALSTATC.reg = (0x1UL);

  ((SCU_Type*) 0x48004000UL)->NMISRC.reg = (0x1UL);


  if (u8_nmiEnTemp == 1u)
  {
    ((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIXTALEN = 1;
  }
  ...
  if (((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIPLL0EN == 1u)
  {
    ((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIPLL0EN = 0;
    u8_nmiEnTemp = 1u;
  }


  ((PLL_Type*) 0x48008000UL)->CON0.reg = (uint32)(0x80200578u) & (~(0x80000000UL));
  ((PLL_Type*) 0x48008000UL)->SPCTR.reg |= (uint32)(0x0u) & ((~(uint32)(0x1UL)) & 0x0000FFFFu);
  ((PLL_Type*) 0x48008000UL)->SPCTR.reg |= (uint32)(0x0u) & (0x1UL);

  ((PLL_Type*) 0x48008000UL)->CON0.bit.PLLEN = 1;
  ...
  ((PLL_Type*) 0x48008000UL)->STATC.reg = (0x1UL);

  ((SCU_Type*) 0x48004000UL)->NMISRC.reg = (0x2UL);


  if (u8_nmiEnTemp == 1u)
  {
    ((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIPLL0EN = 1;
  }
  ...
  if (((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIPLL1EN == 1u)
  {
    ((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIPLL1EN = 0;
    u8_nmiEnTemp = 1u;
  }


  ((PLL_Type*) 0x48008000UL)->CON1.reg = (uint32)(0x801010A0u) & (~(0x80000000UL));
  ((PLL_Type*) 0x48008000UL)->SPCTR.reg |= (uint32)(0x0u) & ((~(uint32)(0x10000UL)) & 0xFFFF0000u);
  ((PLL_Type*) 0x48008000UL)->SPCTR.reg |= (uint32)(0x0u) & (0x10000UL);

  ((PLL_Type*) 0x48008000UL)->CON1.bit.PLLEN = 1;
  ...
  ((PLL_Type*) 0x48008000UL)->STATC.reg = (0x2UL);

  ((SCU_Type*) 0x48004000UL)->NMISRC.reg = (0x4UL);


  if (u8_nmiEnTemp == 1u)
  {
    ((SCU_Type*) 0x48004000UL)->NMICON.bit.NMIPLL1EN = 1;
  }
  ...
  ((SCU_Type*) 0x48004000UL)->CLKEN.reg = (uint32)0u;
  ((SCU_Type*) 0x48004000UL)->CLKCON.reg = (uint32)(0x4E0u);
  ((SCU_Type*) 0x48004000UL)->CLKEN.reg = (uint32)(0x3u);
  return s8_returnCode;
}
...
sint8 SCU_checkXTALDiagnosis(void)
{
  ...
  u32_gpioP2Pud = ((GPIO_Type*) 0x48030000UL)->P2_PUD.reg;
  u32_gpioP2Indis = ((GPIO_Type*) 0x48030000UL)->P2_INDIS.reg;

  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDEN0 = 1u;
  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.bit.INDIS0 = 0u;
  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDSEL0 = 1u;
  SCU_delay_us(5);

  if (((GPIO_Type*) 0x48030000UL)->P2_IN.bit.PI0 == 0u)
  {
    s8_returnCode = (-1);
  }

  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDSEL0 = 0u;
  SCU_delay_us(5);

  if (((GPIO_Type*) 0x48030000UL)->P2_IN.bit.PI0 == 1u)
  {
    s8_returnCode = (-1);
  }

  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDEN0 = 0u;
  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.bit.INDIS0 = 1u;
  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDEN1 = 1u;
  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.bit.INDIS1 = 0u;
  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDSEL1 = 1u;
  SCU_delay_us(5);

  if (((GPIO_Type*) 0x48030000UL)->P2_IN.bit.PI1 == 0u)
  {
    s8_returnCode = (-1);
  }

  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDSEL1 = 0u;
  SCU_delay_us(5);

  if (((GPIO_Type*) 0x48030000UL)->P2_IN.bit.PI1 == 1u)
  {
    s8_returnCode = (-1);
  }

  ((GPIO_Type*) 0x48030000UL)->P2_PUD.bit.PUDEN1 = 0u;
  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.bit.INDIS1 = 1u;


  ((GPIO_Type*) 0x48030000UL)->P2_PUD.reg = u32_gpioP2Pud;
  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.reg = u32_gpioP2Indis;

  return s8_returnCode;
}
# 319 "RTE/Device/TLE9893_2QKW62S/scu.c"
void SCU_delay_us(uint32 u32_time_us)
{
  ...
  }while((u32_systickVal < 100U) || (u32_systickVal > (u32_systickRelVal - 100U)));
  ...
  u32_delayCnt = u32_time_us * (uint32)(0x3Cu);
...
void SCU_initSysTick(uint32 u32_value)
{
  ...
  ((CPU_Type*) 0xE000E000UL)->SYSTICK_RL.reg = u32_value;

  ((CPU_Type*) 0xE000E000UL)->SYSTICK_CUR.reg = (uint32)0u;

  ((CPU_Type*) 0xE000E000UL)->SYSTICK_CS.bit.CLKSOURCE = 1u;

  ((CPU_Type*) 0xE000E000UL)->SYSTICK_CS.bit.TICKINT = 1u;

  ((CPU_Type*) 0xE000E000UL)->SYSTICK_CS.bit.ENABLE = 1u;
}
...
void SCU_enterStopModeWithResetWakeup(void)
{
  ...
  ((PMU_Type*) 0x48000000UL)->WAKE_CTRL.bit.WAKE_W_RST = 1u;

  ((PMU_Type*) 0x48000000UL)->START_CONFIG.bit.CONF = 0u;


  ((SCU_Type*) 0x48004000UL)->CLKSEL.bit.SELSYS0 = 0u;
  ((SCU_Type*) 0x48004000UL)->CLKSEL.bit.SELSYS1 = 0u;

  ((SCU_Type*) 0x48004000UL)->XTALCON.bit.XWDGEN = 0u;
  ((SCU_Type*) 0x48004000UL)->XTALCON.bit.XPD = 1u;

  ((CPU_Type*) 0xE000E000UL)->NVIC_ICER.reg = (uint32)0xFFFFFFFFu;

  ((SCU_Type*) 0x48004000UL)->PMCON0.bit.STOP = 1u;
...
sint8 SCU_enterStopModeWithoutResetWakeup(void)
{
  ...
  u32_p0Dir = ((GPIO_Type*) 0x48030000UL)->P0_DIR.reg;
  u32_p1Dir = ((GPIO_Type*) 0x48030000UL)->P1_DIR.reg;
  u32_p0Pud = ((GPIO_Type*) 0x48030000UL)->P0_PUD.reg;
  u32_p1Pud = ((GPIO_Type*) 0x48030000UL)->P1_PUD.reg;
  u32_p2Pud = ((GPIO_Type*) 0x48030000UL)->P2_PUD.reg;

  u32_int = ((CPU_Type*) 0xE000E000UL)->NVIC_ISER.reg;
  ...
  ((CPU_Type*) 0xE000E000UL)->NVIC_ISER.reg = u32_int;

  ((GPIO_Type*) 0x48030000UL)->P0_DIR.reg = u32_p0Dir;
  ((GPIO_Type*) 0x48030000UL)->P0_PUD.reg = u32_p0Pud;
  ((GPIO_Type*) 0x48030000UL)->P1_DIR.reg = u32_p1Dir;
  ((GPIO_Type*) 0x48030000UL)->P1_PUD.reg = u32_p1Pud;
  ((GPIO_Type*) 0x48030000UL)->P2_PUD.reg = u32_p2Pud;
...
void SCU_enterSleepMode(uint8 u8_enRAMTest)
{
  ...
  ((PMU_Type*) 0x48000000UL)->START_CONFIG.bit.CONF = u8_enRAMTest;

  ((PMU_Type*) 0x48000000UL)->WAKE_STS_CLR.reg = (uint32)0x1FF73F5u;
  ...
  ((SCU_Type*) 0x48004000UL)->PMCON0.bit.SLEEP = 1u;
