# 1 "Can_iso_tp/mcu_lock/mcu_lock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Can_iso_tp/mcu_lock/mcu_lock.c" 2
# 28 "Can_iso_tp/mcu_lock/mcu_lock.c"
...
# 29 "Can_iso_tp/mcu_lock/mcu_lock.c" 2
...
# 30 "Can_iso_tp/mcu_lock/mcu_lock.c" 2
...
void mcu_lock_unlock(mcu_lock_t* lock)
{
# 70 "Can_iso_tp/mcu_lock/mcu_lock.c"
 *lock = 0;
}
