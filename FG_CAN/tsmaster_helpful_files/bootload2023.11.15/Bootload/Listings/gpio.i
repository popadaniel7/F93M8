# 1 "RTE/Device/TLE9893_2QKW62S/gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/gpio.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/gpio.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/gpio.h" 1
# 81 "./RTE/Device/TLE9893_2QKW62S/gpio.h"
...
# 82 "./RTE/Device/TLE9893_2QKW62S/gpio.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/gpio.c" 2
# 61 "RTE/Device/TLE9893_2QKW62S/gpio.c"
void GPIO_init(void)
{

  ((GPIO_Type*) 0x48030000UL)->P0_DIR.reg = (uint32)(0x00u);
  ((GPIO_Type*) 0x48030000UL)->P0_OD.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P0_PUD.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P0_POCON.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P0_ALTSEL0.reg = (uint32)(0x4030u);
  ((GPIO_Type*) 0x48030000UL)->P0_ALTSEL1.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P0_OUT.reg = (uint32)(0x00du);

  ((GPIO_Type*) 0x48030000UL)->P1_DIR.reg = (uint32)(0x018u);
  ((GPIO_Type*) 0x48030000UL)->P1_OD.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P1_PUD.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P1_POCON.reg = (uint32)0X00;
  ((GPIO_Type*) 0x48030000UL)->P1_ALTSEL0.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P1_OUT.reg = (uint32)(0x1Fu);

  ((GPIO_Type*) 0x48030000UL)->P2_INDIS.reg = (uint32)(0x3u);
  ((GPIO_Type*) 0x48030000UL)->P2_PUD.reg = (uint32)(0x0u);
  ((GPIO_Type*) 0x48030000UL)->P2_PUD.reg = (uint32)(0x0u);
}
