# 1 "Uds_server/server.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Uds_server/server.c" 2
# 33 "Uds_server/server.c"
# 1 "./Uds_server/server.h" 1
# 30 "./Uds_server/server.h"
# 1 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h" 1
# 114 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef enum {
...
# 179 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
...
# 180 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h" 2
...
# 181 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h" 2
# 204 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
#pragma clang diagnostic push
...
# 243 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 1825 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 3284 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 3361 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 4891 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 4949 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 5276 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 5333 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 10084 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 12594 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 15104 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 15195 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 16361 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
  volatile const uint32_t RESERVED;
...
# 16994 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 17095 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 17268 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 17660 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 17854 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 18259 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 18360 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 19163 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 19853 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 20157 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 20327 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 20497 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 20586 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 20675 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 20847 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
typedef struct {
...
# 21757 "./RTE/Device/TLE9893_2QKW62S\\tle989x.h"
#pragma clang diagnostic pop
# 31 "./Uds_server/server.h" 2
...
sint8 TLE_init(void);
# 32 "./Uds_server/Config_UdsServer.h" 2
...
# 35 "Uds_server/server.c" 2

# 1 "./Drive\\flash.h" 1
# 37 "Uds_server/server.c" 2
...
static void UDS_Serice_DiagnosticSessionControl(void)
{
 ...
 if(0x02==DataLength)
 {
  ...
  {
   if(0x22==*((uint8_t *)0x18000000))
   {
    *((uint8_t *)0x18000000)=0x11;
    ServerData.txMsgLength=0x06;
    ServerData.txMsgData[0]=ServerData.rxMsgData[0];
    ServerData.txMsgData[1]=ServerData.rxMsgData[1];
    ServerData.txMsgData[2]=0x01;
...
# 270 "Uds_server/server.c"
 static void UDS_Serice_EcuReset(void)
{
 ((PMU_Type*) 0x48000000UL)->GPUDATA2.reg=0xdd;
 if(((PMU_Type*) 0x48000000UL)->GPUDATA2.reg==0xdd)
 {
 __NVIC_SystemReset();
 }
 else
...
# 291 "Uds_server/server.c"
static void UDS_Serice_ReadDataByIdentifier(void)
{

}
# 304 "Uds_server/server.c"
static void UDS_Serice_READ_MEM_BY_ADDR(void)
{

}
# 317 "Uds_server/server.c"
int32_t UDS27_Timelock_count=1000;
static uint32_t Timelock_error_count=0;
uint8_t SecurityAccess_STATION=0xf0;
static void UDS_Serice_SecurityAccess(void)
{
 if( *((uint8_t *)0x18000000)==0x11)
 {
  if(UDS27_Timelock_count<=0)
  {
   if(ServerData.rxMsgData[1]==0x01&&SecurityAccess_STATION==0xf0&&ServerData.rxMsgLength==2)
   {
    ServerData.txMsgLength=4 +2;
    ServerData.txMsgData[0]=ServerData.rxMsgData[0];
    ServerData.txMsgData[1]=ServerData.rxMsgData[1];
   ...
   {
    PasswordGenerator(&UDS_SericeAccess_Seed[0],&UDS_SericeAccess_Key[0],4);
    if(!SecurityAccess_unlock(&ServerData.rxMsgData[2],&UDS_SericeAccess_Key[0],4))
    {
...
# 404 "Uds_server/server.c"
static void UDS_Serice_CommunicationControl(void)
{
 if(*((uint8_t *)0x18000000)==0x22)
 {
  if(ServerData.rxMsgData[1]==0x00)
  {
   udsServer_sendResponse(UDS_NRC_SUB_FUNCTION_NOT_SUPPORTED);
  }
  else if(ServerData.rxMsgData[1]==0x01)
  {
   udsServer_sendResponse(UDS_NRC_SUB_FUNCTION_NOT_SUPPORTED);
  }
  ...
  else if(ServerData.rxMsgData[1]==0x03&&ServerData.rxMsgData[2]==0x01)
  {
  ...
  else if(ServerData.rxMsgData[1]==0x04)
  {
   udsServer_sendResponse(UDS_NRC_SUB_FUNCTION_NOT_SUPPORTED);
  }
  else if(ServerData.rxMsgData[1]==0x05)
  {
  }
  else
  {
...
# 454 "Uds_server/server.c"
static void UDS_Serice_WriteDataByIdentifier(void)
{
 if(*((uint8_t *)0x18000000)==0x11&&SecurityAccess_STATION==0xd0)
 {
    if(ServerData.rxMsgData[1]==0xF1&ServerData.rxMsgData[2]==0x86)
    {
    ...
    else if(ServerData.rxMsgData[1]==0xF1&ServerData.rxMsgData[2]==0x8c)
    {
    ...
    else if(ServerData.rxMsgData[1]==0xF1&ServerData.rxMsgData[2]==0x90)
   {
    ...
    else if(ServerData.rxMsgData[1]==0xF1&ServerData.rxMsgData[2]==0x93)
    {
    if(ServerData.rxMsgLength>=7 )
     {
     ServerData.txMsgLength=0x03;
    ...
    else if(ServerData.rxMsgData[1]==0xF1&ServerData.rxMsgData[2]==0x95)
    {
    if(ServerData.rxMsgLength>=7 )
     {
      ServerData.txMsgLength=0x03;
    ...
    else if(ServerData.rxMsgData[1]==0xF1&ServerData.rxMsgData[2]==0x9d)
    {
    if(ServerData.rxMsgLength>=7 )
    {
     ServerData.txMsgLength=0x03;
...
# 602 "Uds_server/server.c"
static void UDS_Serice_IO_CONTROL(void)
{

}
# 618 "Uds_server/server.c"
static void UDS_Serice_RoutineControl(void)
{
 ...
 user_nvm_page_write_Data.nbyte=0x80;
 ...
 checksum_R=(checksum_R<<8)|ServerData.rxMsgData[7];
  if(*((uint8_t *)0x18000000)==0x11&&SecurityAccess_STATION==0xd0&&checksum==checksum_R)
 {
  Write_the_Bootload_Information[0]=0x55;
  ...
  __disable_irq();
  ( (int32_t(*)(uint32_t, user_nvm_page_write_t *)) (0x105u) )(0x11005F80,&user_nvm_page_write_Data);
  __enable_irq();
...
static void UDS_Serice_RequestDownload(void)
{
 ...
 if(SecurityAccess_STATION==0xd0&&*((uint8_t *)0x18000000)==0x11)
 {
...
# 726 "Uds_server/server.c"
static void UDS_Serice_REQ_UPLOAD(void)
{

}
# 739 "Uds_server/server.c"
...
static void UDS_Serice_TransferData(void)
{
 ...
 if(SecurityAccess_STATION==0xd0&&*((uint8_t *)0x18000000)==0x11)
 {
  if(ServerData.memoryAddress>=0x12002000)
  {
   ...
   {
    __disable_irq();
       flag=( (int32_t(*)(uint32_t, user_nvm_page_write_t *)) (0x105u) )(ServerData.memoryAddress,&user_nvm_page_write_Data);
    ServerData.memoryAddress=ServerData.memoryAddress+128;
    user_nvm_page_write_Data.data=user_nvm_page_write_Data.data+128;
...
# 834 "Uds_server/server.c"
int32_t Serive_Online=5000;
static void UDS_Serice_TesterPresent(void)
{
...
# 860 "Uds_server/server.c"
static void UDS_Serice_WRITE_MEM_BY_ADDR(void)
{

}
# 873 "Uds_server/server.c"
static void UDS_Serice_CountrolDTCSettingRequest(void)
{
 if(*((uint8_t *)0x18000000)==0x22)
 {
...
# 911 "Uds_server/server.c"
void UDS_init(void)
{
 ((PMU_Type*) 0x48000000UL)->GPUDATA2.reg=0xcc;
