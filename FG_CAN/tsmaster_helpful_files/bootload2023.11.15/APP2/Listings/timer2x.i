# 1 "RTE/Device/TLE9893_2QKW62S/timer2x.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "RTE/Device/TLE9893_2QKW62S/timer2x.c" 2
# 33 "RTE/Device/TLE9893_2QKW62S/timer2x.c"
# 1 "./RTE/Device/TLE9893_2QKW62S/timer2x.h" 1
# 89 "./RTE/Device/TLE9893_2QKW62S/timer2x.h"
...
# 90 "./RTE/Device/TLE9893_2QKW62S/timer2x.h" 2
...
#pragma clang diagnostic pop
# 91 "./RTE/Device/TLE9893_2QKW62S/timer2x.h" 2
...
# 92 "./RTE/Device/TLE9893_2QKW62S/timer2x.h" 2
...
# 94 "./RTE/Device/TLE9893_2QKW62S/timer2x.h" 2
# 1 "./RTE/Device/TLE9893_2QKW62S/scu_defines.h" 1
# 95 "./RTE/Device/TLE9893_2QKW62S/timer2x.h" 2
...
# 34 "RTE/Device/TLE9893_2QKW62S/timer2x.c" 2
# 59 "RTE/Device/TLE9893_2QKW62S/timer2x.c"
sint8 T20_init(void)
{
  sint8 s8_returnCode;
  s8_returnCode = (-116);
    ...
    ((T20_Type*) 0x48028000UL)->CON.reg = (uint32)(0x00u);
    ((T20_Type*) 0x48028000UL)->MOD.reg = (uint32)(0x0u);
    ((T20_Type*) 0x48028000UL)->RC.reg = (uint32)(0x0u);
    ((T20_Type*) 0x48028000UL)->CNT.reg = (uint32)(0xFFFFu);
...
sint8 T21_init(void)
{
  sint8 s8_returnCode;
  s8_returnCode = (-116);
# 95 "RTE/Device/TLE9893_2QKW62S/timer2x.c"
  return s8_returnCode;
}
...
sint8 T20_setIntervalTimer(uint32 u32_timeInterval_us)
{
  ...
  uint32 u32_T20Freq_MHz = (uint32)(0x5u);
  ...
  if (u8_T20ClkPrescaler <= 7u)
  {
    ...
    ((T20_Type*) 0x48028000UL)->CON.bit.CP_RL2 = 0u;

    ((T20_Type*) 0x48028000UL)->MOD.bit.DCEN = 0u;

    ((T20_Type*) 0x48028000UL)->MOD.bit.PREN = 1u;

    ((T20_Type*) 0x48028000UL)->MOD.bit.T2PRE = (uint8)u8_T20ClkPrescaler;

    ((T20_Type*) 0x48028000UL)->CNT.bit.T2H = (uint16)u64_timeInterval_ticks >> 8u;
    ((T20_Type*) 0x48028000UL)->CNT.bit.T2L = (uint16)u64_timeInterval_ticks & 0xFFu;

    ((T20_Type*) 0x48028000UL)->RC.bit.RCH2 = (uint16)u64_timeInterval_ticks >> 8u;
    ((T20_Type*) 0x48028000UL)->RC.bit.RCL2 = (uint16)u64_timeInterval_ticks & 0xFFu;
  }
  else
  {
    s8_returnCode = (-122);
...
sint8 T21_setIntervalTimer(uint32 u32_timeInterval_us)
{
  ...
  uint32 u32_T21Freq_MHz = (uint32)(0x5u);
  ...
  if (u8_T21ClkPrescaler <= 7u)
  {
    ...
    ((T21_Type*) 0x4802C000UL)->CON.bit.CP_RL2 = 0u;

    ((T21_Type*) 0x4802C000UL)->MOD.bit.DCEN = 0u;

    ((T21_Type*) 0x4802C000UL)->MOD.bit.PREN = 1u;

    ((T21_Type*) 0x4802C000UL)->MOD.bit.T2PRE = (uint8)u8_T21ClkPrescaler;

    ((T21_Type*) 0x4802C000UL)->CNT.bit.T2H = (uint16)u64_timeInterval_ticks >> 8u;
    ((T21_Type*) 0x4802C000UL)->CNT.bit.T2L = (uint16)u64_timeInterval_ticks & 0xFFu;

    ((T21_Type*) 0x4802C000UL)->RC.bit.RCH2 = (uint16)u64_timeInterval_ticks >> 8u;
    ((T21_Type*) 0x4802C000UL)->RC.bit.RCL2 = (uint16)u64_timeInterval_ticks & 0xFFu;
  }
  else
  {
    s8_returnCode = (-122);
